                    ...
                    <tbody>
                        {films.map((film) => (
                            <tr key={film.id}>
                                ...
                                <td>{film.genre}</td>
                                <td>
                                    <Button variant="warning" size="sm" onClick={() => navigate(`/edit/${film.id}`)} className="me-2">Edit</Button>
                                    <Button variant="danger" size="sm" onClick={() => handleDelete(film.id)}>Hapus</Button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
